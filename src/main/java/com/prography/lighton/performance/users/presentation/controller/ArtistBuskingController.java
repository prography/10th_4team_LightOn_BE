...
import com.prography.lighton.performance.users.presentation.dto.request.SaveArtistBuskingRequest;
...
public class ArtistBuskingController {
    ...
    public ResponseEntity<ApiResult<String>> registerPerformance(
            ...
            MultipartFile proof) {
        RegisterArtistBuskingMultiPart request = new RegisterArtistBuskingMultiPart(data, posterImage, proof);
