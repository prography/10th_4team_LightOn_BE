package com.prography.lighton.member.users.domain.entity;
...
import com.prography.lighton.member.users.domain.entity.association.PreferredArtist;
import com.prography.lighton.member.users.domain.entity.enums.Authority;
import com.prography.lighton.member.users.domain.entity.vo.Email;
import com.prography.lighton.member.users.domain.entity.vo.MarketingAgreement;
import com.prography.lighton.member.users.domain.entity.vo.Password;
import com.prography.lighton.member.users.domain.entity.vo.Phone;
import com.prography.lighton.member.users.domain.exception.InvalidMemberException;
