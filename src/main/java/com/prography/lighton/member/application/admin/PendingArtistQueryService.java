...
public class PendingArtistQueryService implements PendingArtistQueryUseCase {
    ...
    @Override
    public GetArtisApplicationListResponseDTO getAllPendingArtists(int page, int size) {
        return getArtists(PageRequest.of(page, size), Optional.empty());
    }

    @Override
    public GetArtisApplicationListResponseDTO getPendingArtistsByApproveStatus(int page, int size,
                                                                               ApproveStatus approveStatus) {
        return getArtists(PageRequest.of(page, size), Optional.of(approveStatus));
    }

    private GetArtisApplicationListResponseDTO getArtists(Pageable pageable, Optional<ApproveStatus> optionalStatus) {
        ...
        return GetArtisApplicationListResponseDTO.of(dtoPage);
    }
